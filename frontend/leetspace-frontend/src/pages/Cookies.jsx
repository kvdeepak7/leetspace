export default function Cookies() {
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 text-gray-900 dark:text-gray-100">
      <div className="max-w-3xl mx-auto legal-content">
        ...
        <ul>
          <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to myLEETSPACE.</li>
          <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
          <li><strong>Website</strong> refers to myLEETSPACE, accessible from <a href="https://myleetspace.com/" rel="external nofollow noopener" target="_blank">https://myleetspace.com/</a></li>
        ...
        <ul>
          <li>By email: contact@myleetspace.com</li>
        </ul>
      </div>
    </div>
  );
